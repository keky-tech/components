...
// console.log('Test1', registry, result)
...
for (const item of result.data) {
  ...
  "${item.name}": {
    ...
    component: React.lazy(() => import("@/registry/${type}/${
    item.name
  }")),
...
// ----------------------------------------------------------------------------
// Build registry/styles/[name].json.
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
const names = result.data.filter((item) => item.type === "components:ui").map((item) => ({...item, context: 'picasso'}))
